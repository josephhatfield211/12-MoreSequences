...
def run_test_draw_points_on_circle():
    ...
    # ------------------------------------------------------------------
    # Test 4:
    title = 'DRAW_POINTS_ON_CIRCLE, test 4:  10 magenta dots.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 125)
    draw_points_on_circle(window, circle, 10, 'magenta')
    window.close_on_mouse_click()
...
def run_test_pizza():
    ...
    # ------------------------------------------------------------------
    # Test 4:
    title = 'PIZZA test 4:  8 slices, thin (thickness=2) black lines on a yellow circle.'
    window = rg.RoseWindow(400, 400, title)
...
def run_test_polygon():
    ...
    # ------------------------------------------------------------------
    #Test 3:
    title = 'test 3: 10 segments with thin magenta lines.'
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 4:  15 magenta lines on lime green circle, hops = 4.'
    window = rg.RoseWindow(900, 900, title)

    circle = rg.Circle(rg.Point(250, 250), 200)
    circle.fill_color = 'lime green'
    fancy_polygon(window, circle, 15, 4, 'magenta', 4)
    window.close_on_mouse_click()
